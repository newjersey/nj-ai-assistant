...
const Error = ({ text }: { text: string }) => {
  ...
  // NJ: we want the whole error message (skip upstream's 512-char truncation)
  // const errorMessage =
  //   providerText.length > 512 && !jsonString ? providerText.slice(0, 512) + '...' : providerText;
  const defaultResponse = `Something went wrong. Here's the specific error message we encountered: ${providerText}`;
