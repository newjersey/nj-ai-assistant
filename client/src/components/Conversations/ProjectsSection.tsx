    ...
    <div data-testid={`project-chats-${projectId}`}>
      ...
      {hasMore && (
        <Button
          ...
          size="sm"
          onClick={onShowAll}
          className="ml-1 mt-0.5 h-auto rounded-md px-2 py-1 text-xs font-medium text-text-secondary outline-none transition-colors hover:bg-transparent hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black dark:focus-visible:ring-white"
        >
