...
const SearchBar = forwardRef((props: SearchBarProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  return (
    <div
      ref={ref}
      className="group relative mt-3 flex h-10 w-[288px] min-w-0 cursor-pointer items-center gap-3 rounded-lg border border-[#3320151F] px-3 py-1.5 text-text-primary focus-within:border-ring-primary focus-within:bg-surface-active-alt hover:bg-surface-active-alt"
    >
      <Search
        aria-hidden="true"
